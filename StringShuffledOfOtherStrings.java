class StringShuffledOfOtherStrings {
    ...
    static boolean shuffleCheck(String first, String second, String result) {
        ...
        while (k != result.length()) {
            ...
            // check if first character of result matches with first character of first
            // string
            if (i < first.length() && first.charAt(i) == result.charAt(k))
                i++;

            // check if first character of result matches the first character of second
            // string
